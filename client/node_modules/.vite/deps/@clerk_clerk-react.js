...
var unsupportedNonBrowserDomainOrProxyUrlFunction = "Clerk: Unsupported usage of domain or proxyUrl. The usage of domain or proxyUrl as function is not supported in non-browser environments.";
...
var versionSelector = (clerkJSVersion) => {
  ...
  const prereleaseTag = getPrereleaseTag("4.27.1");
  if (prereleaseTag) {
...
var _IsomorphicClerk = class _IsomorphicClerk2 {
  ...
  async loadClerkJS() {
    ...
    try {
      ...
      global.Clerk.sdkMetadata = this.options.sdkMetadata ?? { name: "@clerk/clerk-react", version: "4.27.1" };
...
var SignedIn = ({ children }) => {
  ...
  if (userId) {
    return import_react23.default.createElement(import_react23.default.Fragment, null, children);
  }
  return null;
};
...
var ClerkLoaded = ({ children }) => {
  ...
  return import_react23.default.createElement(LoadedGuarantee, null, children);
};
...
var MultisessionAppSupport = ({ children }) => {
  const session = useSessionContext();
  return import_react23.default.createElement(import_react23.default.Fragment, { key: session ? session.id : "no-users" }, children);
};
...
var WithUser = ({ children }) => {
  ...
  return import_react24.default.createElement(import_react24.default.Fragment, null, children(user));
};
...
var WithSession = ({ children }) => {
  ...
  return import_react25.default.createElement(import_react25.default.Fragment, null, children(session));
};
...
var useAuth = () => {
  ...
  const isomorphicClerk = useIsomorphicClerkContext();
  const getToken = (0, import_react30.useCallback)(createGetToken(isomorphicClerk), [isomorphicClerk]);
  const signOut = (0, import_react30.useCallback)(createSignOut(isomorphicClerk), [isomorphicClerk]);
...
function useMagicLink(resource) {
  ...
  const { startMagicLinkFlow, cancelMagicLinkFlow } = import_react34.default.useMemo(() => resource.createMagicLinkFlow(), [resource]);
...
function useEmailLink(resource) {
  const { startEmailLinkFlow, cancelEmailLinkFlow } = import_react35.default.useMemo(() => resource.createEmailLinkFlow(), [resource]);
